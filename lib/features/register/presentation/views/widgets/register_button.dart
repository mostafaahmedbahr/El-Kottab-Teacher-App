                ...
                onPressed: (){
                  if (formKey.currentState!.validate()) {
                    if(registerCubit.personalPhoto==null){
                      Toast.showErrorToast(msg: LangKeys.pleaseUploadYourPhoto.tr(), context: context);
                    }else if(registerCubit.cvFile==null){
                      Toast.showErrorToast(msg: LangKeys.pleaseUploadYourCv.tr(), context: context);
                    }
                    else if(registerCubit.idFront==null){
                      Toast.showErrorToast(msg: LangKeys.pleaseUploadYourPersonalIDCardFront.tr(), context: context);
                    }
                    else if(registerCubit.idBack==null){
                      Toast.showErrorToast(msg: LangKeys.pleaseUploadYourPersonalIDCardBack.tr(), context: context);
                    }
                    else{
