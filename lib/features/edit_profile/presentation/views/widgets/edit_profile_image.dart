  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileCubit, ProfileStates>(
      buildWhen: (previous, current) {
        return current is EditProfileImageSuccessState ||
            current is EditProfileImageLoadingState ||
            current is EditProfileImageErrorState;
      },
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: editProfileInfoCubit.profileImage != null
                          ? DecorationImage(
                              image: FileImage(
                                editProfileInfoCubit.profileImage!,
                              ),
                              fit: BoxFit.cover,
                            )
                          : null,
                              ...
                              return TextButton(
                                onPressed: () {
                                  editProfileInfoCubit.editProfileInfoData(
                                    name: editProfileInfoCubit.nameCon.text,
                                    email: null,
                                    phoneNumber: null,
                                    gender: null,
                                    description: null,
