...
class GetTeacherPerformanceLoadingState extends HomeStates {}

class GetTeacherPerformanceSuccessState extends HomeStates {
  final TeacherPerformanceModel teacherPerformanceModel;
  GetTeacherPerformanceSuccessState(this.teacherPerformanceModel);
}

class GetTeacherPerformanceErrorState extends HomeStates {
  final String error;
  GetTeacherPerformanceErrorState(this.error);
}
