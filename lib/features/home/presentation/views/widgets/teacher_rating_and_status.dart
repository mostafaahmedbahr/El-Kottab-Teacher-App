          ...
          BlocListener<ProfileCubit, ProfileStates>(
            ...
            child: BlocConsumer<HomeCubit, HomeStates>(
              ...
              builder: (context, state) {
                ...
                return Column(
                  children: [
                    Text(homeCubit.status==true ? LangKeys.available.tr() : LangKeys.unAvailable.tr(), style: AppStyles.black16SemiBold),
                    Gap(6.h),
                    CupertinoSwitch(
          ...
          child: BlocBuilder<HomeCubit, HomeStates>(
            builder: (context, state) {
              ...
              final bool isLoading =
                  state is GetTeacherStatsLoadingState || stats == null;

              return Container(
                padding: EdgeInsets.all(12.r),
                decoration: BoxDecoration(
                  color: isLoading ? Colors.grey[300]! : AppColors.darkOlive,
